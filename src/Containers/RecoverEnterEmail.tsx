    ...
    <ScrollView>
      <View flex-1 style={[Layout.colCenter]}>
        ...
        <View style={Layout.row}>
          <Text marginT-15 style={[Fonts.text15Bold, { color: Colors.GREEN_DARK, }]}>Remember you password?</Text>
          <TouchableOpacity onPress={() => navigation.navigate(ENTER_EMAIL_SCREEN)}>
            <Text marginL-4 marginT-15 style={[Fonts.text15Bold, { color: Colors.GREEN_MAIN, }]}>Login</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
